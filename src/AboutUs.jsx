...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        Our team of experts is dedicated to ensuring that each plant we offer meets our strict standards of quality and care. 
        Whether you're a seasoned gardener or just starting your green journey, we're here to support you every step of the way. 
        Explore our collection, find the perfect plant for your home or office, and let us help you cultivate your own piece of paradise.
      </p>
      <p className="about-us-content">
